...
@Serializable
data class SubscriptionOutput(@SerialName("source_name") val name: String,
    ...
    override fun toString(): String {
        return "SubscriptionOutput(name='$name', sourceUrl='$sourceUrl', type=$type, description=$description)"
    }

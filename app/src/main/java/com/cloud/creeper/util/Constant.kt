 ...
 */
val SUPPORTED_SOURCE_TYPE_LIST = mutableListOf(ClientType.Clash, ClientType.V2Ray)
val SUPPORTED_OUTPUT_TYPE_LIST = mutableListOf(ClientType.Clash, ClientType.V2Ray)
